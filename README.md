...
| <img src="https://raw.githubusercontent.com/voc0der/jellyfin-seerr-proxy/main/icon.png" alt="" width="20" align="top"> [Seerr Proxy](https://github.com/voc0der/jellyfin-seerr-proxy) | Proxy Seerr API calls through Jellyfin authentication | [1.0.0.8](https://github.com/voc0der/jellyfin-seerr-proxy/releases/tag/1.0.0.8) | 10.11.6+ |

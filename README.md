...
| <img src="https://raw.githubusercontent.com/voc0der/jellyfin-plugin-transcode-guard/main/icon.png" alt="" width="20" align="top"> [Transcode Guard](https://github.com/voc0der/jellyfin-plugin-transcode-guard) | Smart transcoding monitor that only alerts for format/codec incompatibility | [1.0.1.43](https://github.com/voc0der/jellyfin-plugin-transcode-guard/releases/tag/v1.0.1.43) | 10.9+ |
| <img src="https://raw.githubusercontent.com/voc0der/jellyfin-plugin-transcode-guard/main/icon.png" alt="" width="20" align="top"> [Transcode Nag](https://github.com/voc0der/jellyfin-plugin-transcode-guard) | Retired -- superseded by Transcode Guard, which installs alongside it | [1.0.1.40](https://github.com/voc0der/jellyfin-plugin-transcode-guard/releases/tag/v1.0.1.40) | 10.9+ |
